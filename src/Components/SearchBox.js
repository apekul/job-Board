      ...
      <div className="flex h-auto my-3 flex-col sm:flex-row  gap-3">
        ...
        <div className="relative rounded-md shadow-sm">
          ...
          <input
            ...
            id="name"
            value={name}
            className="block min-w-[20rem] rounded-md border-0 py-1.5 pl-10  text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            placeholder="Search"
            onChange={updateName}
          />
        </div>
